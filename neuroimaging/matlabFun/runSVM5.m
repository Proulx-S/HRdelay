function hitRate = runSVM5(d,p,verbose,rep,doPerm)
    ...
    if ~exist('sortIndFix','var')
        switch p.keepInfo
            ...
            case 'p'
                ...
                p.sort.feat = 1-pval;
            case 'i'
                [~,Y] = pol2cart(tr.delay,1);
                p.sort.feat = computeMI(Y,tr.label==1,tr.label==2)';
            case 'mp'
            ...
            if p.doSVM
                ...
                switch p.keepInfo
                    ...
                    case 'p'
                        ...
                        teFinal.label = te.label;
                    case 'i'
                        [~,trFinal.data] = pol2cart(tr.delay,1);
                        trFinal.label = tr.label;
                        [~,teFinal.data] = pol2cart(te.delay,1);
                        teFinal.label = te.label;
                    case 'mp'
                        complexFlag = 1;
                        [X,Y] = pol2cart(tr.delay,tr.amp);
