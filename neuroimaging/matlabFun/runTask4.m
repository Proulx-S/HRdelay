function [ output_args ] = runTask4(allFile,altPerm,altMainDir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Warning !! See line 394
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                switch p.preSelection
                    case {'eqSess','sess1','sess2'}
                        ...
                        for ii = 1:size(metric.voxInd,1)
                            ...
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                            % This here takes the stats value for the first
                            % condition (first grating, not plaid). So we
                            % must beware that svm is likely to be biased
                            % since testing examples will have contributed
