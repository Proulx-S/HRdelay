function out = runSVM_patAct6(d,p,verbose,rep)
...
%         for i = 1:size(out.crossInfo.d,1)
        ...
        tmp = []; for i = 1:length(out.crossInfo_dim1Train(p.layeredSVM_l1Tol2ind)); tmp = [tmp out.crossInfo_dim1Train{p.layeredSVM_l1Tol2ind(i)} '+']; end; tmp(end) = [];
