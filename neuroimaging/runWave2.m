...
for subjInd = 1:length(subjList)
    filename1 = fullfile(repo,funDir,inDir,subjList{subjInd},[maskLabel 'SinCos']);
    load([filename1 '_detrendedData.mat']);
    for i = 1:length(detrendedData)
        
        getWaves(detrendedData{i})
